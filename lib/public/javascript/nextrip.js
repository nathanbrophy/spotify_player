...
/**
 * Return address of coordinates.
 * :param coordinates: {lat: lat, lng: lng}
 */
let addrOfCoor = coordinates => {
  var geocoder = new google.maps.Geocoder();
  let request = { 'location': coordinates };
...
window.onload = () => {
  ...
  var json = { lat: parseFloat(44.33), lng: parseFloat(-91.23) };
  addrOfCoor(json);
};